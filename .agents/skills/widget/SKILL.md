...
- Template directory: `$CODEX_HOME/skills/widget/templates/` after install, defaulting to `~/.codex/skills/widget/templates/`
...
- Use `bash "${CODEX_HOME:-$HOME/.codex}/skills/widget/scripts/doctor.sh"` only for a fast post-install health check
- After setup, use the installed skill path under `$CODEX_HOME/skills/widget/`
...
bash "${CODEX_HOME:-$HOME/.codex}/skills/widget/scripts/doctor.sh"

# Start Übersicht
bash "${CODEX_HOME:-$HOME/.codex}/skills/widget/scripts/start-uebersicht.sh"

# Install or update a template widget
bash "${CODEX_HOME:-$HOME/.codex}/skills/widget/scripts/install-widget.sh" \
  "${CODEX_HOME:-$HOME/.codex}/skills/widget/templates/clock.jsx"

# List installed widgets
bash "${CODEX_HOME:-$HOME/.codex}/skills/widget/scripts/list-widgets.sh"
